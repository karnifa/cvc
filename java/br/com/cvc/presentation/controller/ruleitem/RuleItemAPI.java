...
public sealed interface RuleItemAPI permits RuleItemRestController {

	@Operation(summary = "Lista todos os items de uma determinada regra.")
	@ApiResponse(responseCode = "200", description = Constants.API_RESPONSE_200)
	List<RuleItemResponseModel> findAllByRuleId(@Parameter Long ruleId);
